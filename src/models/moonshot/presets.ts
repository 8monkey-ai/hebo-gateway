...
export const kimiK25 = presetFor<CanonicalModelId, CatalogModel>()("moonshot/kimi-k2.5" as const, {
  ...KIMI_BASE,
  name: "Kimi K2.5",
  created: "2026-01-27",
  knowledge: "2025-06",
...
export const kimiK26 = presetFor<CanonicalModelId, CatalogModel>()("moonshot/kimi-k2.6" as const, {
  ...KIMI_BASE,
  name: "Kimi K2.6",
  created: "2026-04-20",
